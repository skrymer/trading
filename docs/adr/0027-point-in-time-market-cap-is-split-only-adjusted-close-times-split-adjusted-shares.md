...
5. **Scope:** this primitive only. Consumers own their cap-derived predicates — the **#168** NARROW concentration axis (top-N-by-cap universe + cap-weighted return contribution) and the **#173 / ADR-0026** optional `$300M` tradable cap floor. The top-N-by-cap universe must inherit the ADR-0011 point-in-time STOCK-or-null + survivorship properties (delisted names keep bars; respect the 2000 floor) so the early-era top-N is not survivor-tilted.
