...
See `CONTEXT.md` *Crisis defense* / *Coverage* / *Regime specialist* for the terms, and the [regime-conditional portfolio program post-mortem](../../knowledge/wiki/synthesis/regime-conditional-portfolio.md) for the (now-abandoned) trading plan this governs. This ADR records *why* there is no defender so a future session does not re-propose one.
