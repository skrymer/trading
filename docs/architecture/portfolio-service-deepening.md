...
- 2 new test classes: `PortfolioTest` (plain JUnit, ~3 cases), `PortfolioControllerIT` (extends `AbstractIntegrationTest`, 8 cases — sets the codebase precedent for full-integration controller tests per [ADR 0002](../adr/0002-controller-tests-use-full-integration.md))
