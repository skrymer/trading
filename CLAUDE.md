...
- `/validate-candidate` → `firewall-analyst` (3-block firewall: Block A 2000-2014, Block B 2014-2020 incl COVID, Block C 2021-2025; strict v4 gates + design-isolation + cross-block edge-decay; emits TRADABLE / PROVISIONAL / INCONCLUSIVE_G11 / REJECTED verdict)
