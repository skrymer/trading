...
- [[minervini-vcp-breakout]] — breakout-in-uptrend; REJECTED as all-weather (participate-and-lose), but the broad-thrust edge is real → shelved building block. PRD-confirmed 2026-06-13 (THRUST +7.45 / CRISIS −3.05); labeled **could-be-tradable as a THRUST-regime specialist** (hypothesis, confirm via regime-conditional firewall, not by gating). #83 market-level-gate rescue ([[r1-leadership-gap-breakout]]) closed.
