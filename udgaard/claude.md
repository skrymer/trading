...
│   │   │   └── RegimeController.kt       # GET /api/regime/readout?after=&before= (daily 5-label series) + GET /api/regime/current (latest read as of the NY trading day, 404 when none); read-out only, never a deploy/cash switch (ADR 0010/0023)
│   │   ├── dto/                      # DTOs
