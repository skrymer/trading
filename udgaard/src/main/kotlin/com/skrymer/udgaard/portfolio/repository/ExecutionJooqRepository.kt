...
import com.skrymer.udgaard.portfolio.mapper.ExecutionMapper
...
class ExecutionJooqRepository(
   ...
   */
  fun findById(id: Long): Execution? {
    val execution =
      dsl
   ...
   */
  fun findByPositionId(positionId: Long): List<Execution> {
    val executions =
      dsl
        .selectFrom(EXECUTIONS)
   ...
   */
  fun findByBrokerTradeId(brokerTradeId: String): Execution? {
    val execution =
      dsl
        .selectFrom(EXECUTIONS)
