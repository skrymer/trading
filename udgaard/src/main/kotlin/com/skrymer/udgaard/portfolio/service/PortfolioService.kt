...
class PortfolioService(
   ...
   * Get portfolio by ID
   */
  fun getPortfolio(portfolioId: Long): Portfolio? = portfolioRepository.findById(portfolioId)
   ...
   */
  fun updatePortfolioWithBrokerInfo(portfolio: Portfolio): Portfolio = portfolioRepository.save(portfolio)
