...
import com.skrymer.udgaard.controller.dto.ClosePositionRequest
import com.skrymer.udgaard.controller.dto.CreatePositionRequest
import com.skrymer.udgaard.controller.dto.PositionUnrealizedPnlResponse
import com.skrymer.udgaard.controller.dto.PositionWithExecutionsResponse
import com.skrymer.udgaard.controller.dto.UpdatePositionMetadataRequest
...
import com.skrymer.udgaard.service.PositionService
import com.skrymer.udgaard.service.UnrealizedPnlService
...
class PositionController(
  ...
  ): ResponseEntity<List<PositionDomain>> {
    val positionStatus = status?.let { PositionStatusDomain.valueOf(it.uppercase()) }
  ...
  ): ResponseEntity<PositionDomain> = try {
    val position =
  ...
  fun getRollChain(
    @PathVariable portfolioId: Long,
    @PathVariable positionId: Long,
  ): ResponseEntity<List<PositionDomain>> = try {
