...
class DefaultStockFactory(
    ...
    override fun enrichQuotes(
      ...
      spy: OvtlyrStockInformation
        ...
        val enrichedQuotes = ovtlyrEnrichmentService.enrichWithOvtlyr(
            quotesWithATR,
            symbol,
            marketBreadth,
            sectorBreadth,
    ...
    override fun createStock(
        ...
        logger.info("Creating Stock entity for $symbol with ${enrichedQuotes.size} quotes, ${orderBlocks.size} order blocks, and ${earnings.size} earnings")
