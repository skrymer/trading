...
data class AlphaVantageEtfProfile(
  ...
  fun getErrorDescription(): String = errorMessage ?: note ?: information ?: "Unknown error"
   ...
   */
  fun getNetAssetsAsDouble(): Double? = netAssets?.toDoubleOrNull()
   ...
   */
  fun isLeveraged(): Boolean = leveraged?.uppercase() == "YES"
}
