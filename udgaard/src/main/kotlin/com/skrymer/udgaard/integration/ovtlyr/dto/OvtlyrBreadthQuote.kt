...
class OvtlyrBreadthQuote {
  ...
  fun toModel(
    ...
    return BreadthQuoteDomain(
      ...
      numberOfStocksInDowntrend = numberOfStocksInDowntrend,
      numberOfStocksInNeutral = numberOfStocksInNeutral,
      numberOfStocksInUptrend = numberOfStocksInUptrend,
      numberOfStocksWithABuySignal = numberOfStocksWithABuySignal,
      numberOfStocksWithASellSignal = numberOfStocksWithASellSignal,
      ...
      quoteDate = quoteDate ?: LocalDate.now(),
      symbol = symbol ?: "",
    )
  }
