...
enum class EtfSymbol(val description: String) {
    ...
    companion object {
         ...
         */
        fun getStandardEtfs(): List<EtfSymbol> {
            return listOf(SPY, QQQ, IWM, DIA)
        }
         ...
         */
        fun getLeveragedEtfs(): List<EtfSymbol> {
            return listOf(TQQQ, SQQQ, UPRO, SPXU)
        }
    }
    ...
    fun isLeveraged(): Boolean {
        return this in listOf(TQQQ, SQQQ, UPRO, SPXU)
    }
    ...
    fun isInverse(): Boolean {
        return this in listOf(SQQQ, SPXU)
    }
