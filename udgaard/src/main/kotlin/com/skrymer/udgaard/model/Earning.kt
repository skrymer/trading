...
data class Earning(
     ...
     */
    fun isWithinDaysOf(date: LocalDate, days: Int): Boolean {
        val earningsDate = reportedDate ?: return false
        val daysDiff = java.time.temporal.ChronoUnit.DAYS.between(date, earningsDate)
        return daysDiff in 0..days.toLong()
    }

    override fun toString(): String {
        return "Earning(symbol=$symbol, fiscalDate=$fiscalDateEnding, reportedDate=$reportedDate, " +
    ...
    override fun hashCode(): Int {
        return id?.hashCode() ?: (symbol.hashCode() * 31 + fiscalDateEnding.hashCode())
    }
}
