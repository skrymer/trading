...
data class PortfolioTrade(
   ...
   */
  fun getStrategySymbol(): String = underlyingSymbol ?: AssetMapper.getUnderlyingSymbol(symbol)
   ...
   */
  fun calculateUnrealizedProfitPercentage(currentPrice: Double): Double = ((currentPrice - entryPrice) / entryPrice) * 100.0
  ...
  fun daysToExpiration(): Long? =
    if (instrumentType == InstrumentType.OPTION && expirationDate != null) {
