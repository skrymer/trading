...
class Breadth {
  ...
  fun getDonkeyScoreByDate(date: LocalDate): Int = quotes.firstOrNull { it.quoteDate?.equals(date) == true }?.donkeyChannelScore ?: 0

  fun getQuoteForDate(date: LocalDate?): BreadthQuote? = quotes.firstOrNull { date == it.quoteDate }
