...
class UnrealizedPnlService(
  ...
  private fun calculateRolledCreditsAndEntryPrice(
    ...
    try {
      ...
      var mostRecentRollBuyExecution: ExecutionDomain? = null
  ...
  fun calculateUnrealizedPnl(portfolioId: Long): List<PositionUnrealizedPnlResponse> =
    runBlocking(Dispatchers.IO) {
      val openPositions = positionService.getPositions(portfolioId, PositionStatusDomain.OPEN)
            ...
            try {
              ...
              val currentPrice =
                when (position.instrumentType) {
                  ...
                  InstrumentTypeDomain.STOCK, InstrumentTypeDomain.LEVERAGED_ETF -> {
