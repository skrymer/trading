...
class StrategyRegistry(
     ...
     */
    fun getAvailableEntryStrategies(): List<String> {
        return entryStrategies.keys.sorted()
    }

    /**
     * Get all available exit strategy names.
     */
    fun getAvailableExitStrategies(): List<String> {
        return exitStrategies.keys.sorted()
    }
     ...
     */
    fun registerEntryStrategy(name: String, factory: () -> EntryStrategy) {
     ...
     * Useful for testing or dynamic strategy creation.
     */
    fun registerExitStrategy(name: String, factory: () -> ExitStrategy) {
