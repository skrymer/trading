...
class OrderBlockCalculator {
     ...
     */
    data class Crossing(val index: Int, val type: OrderBlockType)
    ...
    private fun mitigateBlocks(
        ...
        val blocksToMitigate = activeBlocks.filter { block ->
