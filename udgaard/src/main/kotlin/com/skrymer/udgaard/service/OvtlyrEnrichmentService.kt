...
class OvtlyrEnrichmentService(
    ...
    fun enrichWithOvtlyr(
        ...
        val ovtlyrQuotesByDate = ovtlyrStock.getQuotes()
            .filterNotNull()
        ...
        val enrichedQuotes = alphaQuotes.mapNotNull { alphaQuote ->
     ...
     */
    private fun calculateMarketAdvancingPercent(marketBreadth: Breadth?, date: java.time.LocalDate): Double {
