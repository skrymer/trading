package com.skrymer.udgaard.data.util
...
object AssetMapper {
   ...
   */
  private val leveragedToUnderlying =
    mapOf(
      // Nasdaq QQQ
      "TQQQ" to "QQQ", // 3x Bull
      "SQQQ" to "QQQ", // 3x Bear
   ...
   */
  fun getUnderlyingSymbol(symbol: String): String = leveragedToUnderlying[symbol.uppercase()] ?: symbol.uppercase()
   ...
   */
  fun isLeveragedETF(symbol: String): Boolean = leveragedToUnderlying.containsKey(symbol.uppercase())
   ...
   */
  fun getAllMappings(): Map<String, String> = leveragedToUnderlying.toMap()
}
