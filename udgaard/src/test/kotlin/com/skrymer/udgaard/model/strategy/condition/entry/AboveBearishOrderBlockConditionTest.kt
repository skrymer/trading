...
class AboveBearishOrderBlockConditionTest {
  ...
  private fun createTradingDayQuotes(
    ...
    while (!currentDate.isAfter(endDate)) {
      ...
      if (currentDate.dayOfWeek.value < 6) {
        quotes.add(StockQuoteDomain(date = currentDate, closePrice = defaultClosePrice))
      }
  ...
  fun `should return true when price above bearish order block for 3 consecutive days`() {
    ...
    quotes.addAll(
      listOf(
        StockQuoteDomain(date = LocalDate.of(2024, 2, 27), closePrice = 106.0),
        StockQuoteDomain(date = LocalDate.of(2024, 2, 28), closePrice = 107.0),
        StockQuoteDomain(date = LocalDate.of(2024, 2, 29), closePrice = 108.0),
      ),
    )
  ...
  fun `should return false when price was inside OB within cooldown period`() {
    ...
    quotes.addAll(
      listOf(
        StockQuoteDomain(date = LocalDate.of(2024, 2, 27), closePrice = 102.0), // Inside OB
        StockQuoteDomain(date = LocalDate.of(2024, 2, 28), closePrice = 106.0), // Above
        StockQuoteDomain(date = LocalDate.of(2024, 2, 29), closePrice = 108.0), // Above
      ),
    )
  ...
  fun `should return true when no relevant bearish order blocks exist`() {
    ...
    val stock =
      StockDomain(
        ...
        quotes =
          listOf(
            StockQuoteDomain(date = LocalDate.of(2024, 2, 18), closePrice = 106.0),
            StockQuoteDomain(date = LocalDate.of(2024, 2, 19), closePrice = 107.0),
            StockQuoteDomain(date = LocalDate.of(2024, 2, 20), closePrice = 108.0),
          ),
  ...
  fun `should return false when insufficient cooldown bars since inside OB`() {
    ...
    val quotes =
      listOf(
        StockQuoteDomain(date = LocalDate.of(2024, 2, 18), closePrice = 100.0), // Inside OB
        StockQuoteDomain(date = LocalDate.of(2024, 2, 19), closePrice = 107.0), // Above
        StockQuoteDomain(date = LocalDate.of(2024, 2, 20), closePrice = 108.0), // Above
      )
  ...
  fun `should work with different consecutive day parameters`() {
    ...
    quotes.addAll(
      listOf(
        StockQuoteDomain(date = LocalDate.of(2024, 2, 25), closePrice = 106.0),
        StockQuoteDomain(date = LocalDate.of(2024, 2, 26), closePrice = 107.0),
        StockQuoteDomain(date = LocalDate.of(2024, 2, 27), closePrice = 108.0),
        StockQuoteDomain(date = LocalDate.of(2024, 2, 28), closePrice = 109.0),
        StockQuoteDomain(date = LocalDate.of(2024, 2, 29), closePrice = 110.0),
      ),
    )
  ...
  fun `should work with different age parameters`() {
    ...
    quotes.addAll(
      listOf(
        StockQuoteDomain(date = LocalDate.of(2024, 3, 28), closePrice = 106.0),
        StockQuoteDomain(date = LocalDate.of(2024, 3, 29), closePrice = 107.0),
        StockQuoteDomain(date = LocalDate.of(2024, 4, 1), closePrice = 108.0),
      ),
    )
  ...
  fun `should handle multiple order blocks and block when currently inside any`() {
    ...
    quotes.addAll(
      listOf(
        StockQuoteDomain(date = LocalDate.of(2024, 2, 27), closePrice = 100.0), // Inside OB1
        StockQuoteDomain(date = LocalDate.of(2024, 2, 28), closePrice = 102.0), // Inside OB1
        StockQuoteDomain(date = LocalDate.of(2024, 2, 29), closePrice = 103.0), // Inside OB1
      ),
    )
  ...
  fun `should provide detailed evaluation when failing due to recent cooldown`() {
    ...
    quotes.addAll(
      listOf(
        StockQuoteDomain(date = LocalDate.of(2024, 2, 27), closePrice = 102.0), // Inside OB
        StockQuoteDomain(date = LocalDate.of(2024, 2, 28), closePrice = 107.0), // Above
        StockQuoteDomain(date = LocalDate.of(2024, 2, 29), closePrice = 108.0), // Above
      ),
    )
  ...
  fun `should return false when any day was inside order block recently`() {
    ...
    quotes.addAll(
      listOf(
        StockQuoteDomain(date = LocalDate.of(2024, 2, 27), closePrice = 110.0), // Above
        StockQuoteDomain(date = LocalDate.of(2024, 2, 28), closePrice = 100.0), // Inside
        StockQuoteDomain(date = LocalDate.of(2024, 2, 29), closePrice = 92.0), // Below (current)
      ),
    )
  ...
  fun `should return false when current day is inside order block`() {
    ...
    quotes.addAll(
      listOf(
        StockQuoteDomain(date = LocalDate.of(2024, 2, 27), closePrice = 110.0), // Above
        StockQuoteDomain(date = LocalDate.of(2024, 2, 28), closePrice = 108.0), // Above
        StockQuoteDomain(date = LocalDate.of(2024, 2, 29), closePrice = 100.0), // Inside (current)
      ),
    )
  ...
  fun `should return true when price never entered order block`() {
    ...
    quotes.addAll(
      listOf(
        StockQuoteDomain(date = LocalDate.of(2024, 2, 27), closePrice = 90.0), // Below (not inside)
        StockQuoteDomain(date = LocalDate.of(2024, 2, 28), closePrice = 107.0), // Above
        StockQuoteDomain(date = LocalDate.of(2024, 2, 29), closePrice = 110.0), // Above (current)
      ),
    )
  ...
  fun `should provide detailed evaluation when recently inside OB`() {
    ...
    quotes.addAll(
      listOf(
        StockQuoteDomain(date = LocalDate.of(2024, 2, 27), closePrice = 110.0),
        StockQuoteDomain(date = LocalDate.of(2024, 2, 28), closePrice = 100.0), // Inside
        StockQuoteDomain(date = LocalDate.of(2024, 2, 29), closePrice = 92.0),
      ),
    )
  ...
  fun `should provide detailed evaluation when current day is inside order block`() {
    ...
    quotes.addAll(
      listOf(
        StockQuoteDomain(date = LocalDate.of(2024, 2, 27), closePrice = 110.0),
        StockQuoteDomain(date = LocalDate.of(2024, 2, 28), closePrice = 108.0),
        StockQuoteDomain(date = LocalDate.of(2024, 2, 29), closePrice = 100.0), // Inside
      ),
    )
  ...
  fun `should block entry when previous day was inside order block even if order block ends on entry date`() {
    ...
    quotes.addAll(
      listOf(
        StockQuoteDomain(date = LocalDate.of(2024, 6, 28), closePrice = 197.88), // INSIDE OB
        StockQuoteDomain(date = LocalDate.of(2024, 7, 1), closePrice = 209.86), // ABOVE OB
        StockQuoteDomain(date = LocalDate.of(2024, 7, 2), closePrice = 231.26), // ABOVE OB
      ),
    )
