  ...
  fun `should work with 5 consecutive days`() {
    ...
    val stock =
      Stock(
        quotes =
          mutableListOf(
            StockQuote(date = LocalDate.of(2023, 12, 31), high = 100.0, closePrice = 100.0, closePriceEMA20 = 100.0, atr = 2.0),
            StockQuote(date = LocalDate.of(2024, 1, 1), high = 101.0, closePrice = 101.0, closePriceEMA20 = 100.0, atr = 2.0),
            StockQuote(date = LocalDate.of(2024, 1, 2), high = 101.5, closePrice = 101.5, closePriceEMA20 = 100.0, atr = 2.0),
            StockQuote(date = LocalDate.of(2024, 1, 3), high = 102.0, closePrice = 102.0, closePriceEMA20 = 100.0, atr = 2.0),
            StockQuote(date = LocalDate.of(2024, 1, 4), high = 102.5, closePrice = 102.5, closePriceEMA20 = 100.0, atr = 2.0),
            StockQuote(date = LocalDate.of(2024, 1, 5), high = 103.0, closePrice = 103.0, closePriceEMA20 = 100.0, atr = 2.0),
          ),
      )
      ...
      Stock(
        quotes =
          mutableListOf(
            StockQuote(date = LocalDate.of(2023, 12, 31), high = 100.0, closePrice = 100.0, closePriceEMA20 = 100.0, atr = 2.0),
            StockQuote(date = LocalDate.of(2024, 1, 1), high = 101.0, closePrice = 101.0, closePriceEMA20 = 100.0, atr = 2.0),
            StockQuote(date = LocalDate.of(2024, 1, 2), high = 102.0, closePrice = 102.0, closePriceEMA20 = 100.0, atr = 2.0),
            StockQuote(date = LocalDate.of(2024, 1, 3), high = 103.0, closePrice = 103.0, closePriceEMA20 = 100.0, atr = 2.0),
          ),
      )
    ...
    val stock =
      Stock(
        quotes =
          mutableListOf(
            StockQuote(date = LocalDate.of(2023, 12, 31), high = 100.0, closePrice = 100.0, closePriceEMA20 = 100.0, atr = 2.0),
            StockQuote(date = LocalDate.of(2024, 1, 1), high = 103.0, closePrice = 103.0, closePriceEMA20 = 100.0, atr = 2.0),
            StockQuote(date = LocalDate.of(2024, 1, 2), high = 102.0, closePrice = 101.0, closePriceEMA20 = 100.0, atr = 2.0),
            StockQuote(date = LocalDate.of(2024, 1, 3), high = 103.0, closePrice = 102.0, closePriceEMA20 = 100.0, atr = 2.0),
          ),
      )
